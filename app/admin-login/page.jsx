        ...
        <div style={{ background: '#2a2a2a', border: '1px solid #cc0000', borderRadius: '8px', padding: '1rem 1.5rem', marginBottom: '1.5rem' }}>
          ...
          {isIOS ? (
            <div style={{ marginTop: '0.75rem' }}>
              ...
              <p style={{ margin: '0.25rem 0', color: '#ccc', fontSize: '0.85rem' }}>1. Tap the <strong style={{ color: '#fff' }}>Share</strong> button in Safari</p>
              <p style={{ margin: '0.25rem 0', color: '#ccc', fontSize: '0.85rem' }}>2. Tap <strong style={{ color: '#fff' }}>"Add to Home Screen"</strong></p>
              <p style={{ margin: '0.25rem 0', color: '#ccc', fontSize: '0.85rem' }}>3. Tap <strong style={{ color: '#fff' }}>"Add"</strong></p>
            </div>
          ) : isMac ? (
            <div style={{ marginTop: '0.75rem' }}>
